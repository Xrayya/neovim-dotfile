local convert_to_hex = require("xrayya.utils.color").convert_decimal_to_hex
...
return {
  ...
  opts = {
    ...
    highlights = {
      undo = {
        hl_color = {
          bg = convert_to_hex(vim.api.nvim_get_hl(0, { name = "rainbowdelimiterred" }).fg) or "#693232",
        },
      },
      redo = {
      ...
      cursor = {
        hl_color = {
          bg = convert_to_hex(vim.api.nvim_get_hl(0, { name = "RainbowDelimiterRed" }).fg) or "#793D54",
        },
      },
    },
    priority = 2048 * 3,
